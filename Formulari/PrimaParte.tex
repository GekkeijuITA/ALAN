...
\begin{tabular}{| m{2cm} | m{10cm} |}
    ...
    \hline
    Esercizio 2 & Calcolare il det di una 2x2 a caso, se det $\neq 0$ allora $rk(A)\geq 2$ possiamo orlarla, calcoliamo il det della 3x3 e dobbiamo farlo per tutte le possibili 3x3 a partire da quella 2x2, le $\lambda$ in comune sono quelle che rk(A)=2, tutte le altre rk(A)=3\\
    \hline
\end{tabular}
\end{minipage}
