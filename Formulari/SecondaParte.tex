...
\end{equation*}
Per verificare la stabilità dell'algoritmo bisogna fare il limite  di tutti gli archi e se viene finito (per tutti gli archi) è stabile, altrimenti è instabile (ne basta uno per verificarlo).
\subsection*{Esempio}
